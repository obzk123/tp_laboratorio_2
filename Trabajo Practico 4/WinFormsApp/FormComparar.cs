    ...
    public partial class FormComparar : Form
    {
        ...
        public void CargarDatosE1()
        {
            ...
            if (this.e1.Ganados > 0)
            {
                ...
                this.richTxt1.Text += String.Format("\nProbabilidad de victoria: {0}%", probGanados);
            }
            else
            {
            ...
            if (this.e1.Perdidos > 0)
            {
                ...
                this.richTxt1.Text += String.Format("\nProbabilidad de derrota: {0}%", probPerdidos);
            }
            else
            {
            ...
            if (this.e1.GolesAFavor > 0)
            {
                ...
                this.richTxt1.Text += String.Format("\nPromedio de gol a favor por partido: {0}", promGolesFavor);
            }
            else
            {
            ...
            if (this.e1.GolesEnContra > 0)
            {
                ...
                this.richTxt1.Text += String.Format("\nPromedio de gol en contra por partido: {0}", promGolesEnContra);
            }
            else 
            {
